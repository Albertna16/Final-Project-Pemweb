<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'GET') {
      if (isset($_GET['ID_USER'])) {
          ...
          $query = $conn->prepare("SELECT NAMA_USER, ADDRESS, NUMBER_PHONE FROM user WHERE ID_USER = :ID_USER");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        //query SQL
        $query = $conn->prepare("UPDATE user SET NAMA_USER=:NAMA_USER, ADDRESS=:ADDRESS, NUMBER_PHONE=:NUMBER_PHONE WHERE ID_USER=:ID_USER");
